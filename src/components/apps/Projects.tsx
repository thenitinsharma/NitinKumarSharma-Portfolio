...
const PROJECTS: Project[] = [
  ...
  {
    id: "ai-researcher-agent",
    name: "AI Researcher Agent",
    description:
      "Autonomous LangGraph research agent that searches arXiv, synthesizes papers, and drafts LaTeX-rendered research papers",
    longDescription:
      "AI Researcher is an autonomous research agent with a conversational chat interface. Given a research query or topic, the agent autonomously reasons through a multi-step workflow—deciding when to query the arXiv API, inspect and extract text from research PDFs via PyPDF2, discuss findings and future research directions, and compile full papers typeset in LaTeX via Tectonic into downloadable PDFs. Features server-side conversation checkpointing via LangGraph MemorySaver and client-side BYO Groq API key support.",
    image: "/projects/ai-researcher-agent.jpg",
    techStack: [
      "LangGraph",
      "FastAPI",
      "ChatGroq",
    ...
    category: "AI/ML",
    year: "2025",
    github: "https://github.com/thenitinsharma/ai-researcher-agent",
    demo: "https://ai-researcher-agent-brown.vercel.app",
    metrics: [
      { label: "Autonomy", value: "Multi-Tool" },
      { label: "Compiler", value: "Tectonic LaTeX" },
      { label: "Engine", value: "LangGraph" },
    ],
    featured: true,
    highlights: [
      "Engineered an autonomous research agent using LangGraph StateGraph, ToolNode, and Groq-hosted models (openai/gpt-oss-120b)",
      "Implemented an autonomous tool-calling loop for querying arXiv API, extracting PDF text with PyPDF2, and compiling LaTeX into publication-ready PDFs",
  ...
  },
  {
    ...
    name: "AI Research Assistant System",
    description:
      "Semantic search, RAG Q&A, and topic clustering platform built over 15,000+ ML arXiv research papers",
    longDescription:
      "AI Research Assistant System is a comprehensive NLP platform indexing 15,000+ machine learning research papers from arXiv. Built during an internship at Coding Block School of Technology (CBSOT), the system enables researchers to semantically query literature using Sentence Transformers and FAISS, generate abstract summaries with BART, extract entity-typed keywords with KeyBERT and zero-shot classifiers, explore unsupervised topic clusters with BERTopic, and query documents with source-cited RAG answers via Groq.",
    image: "/projects/ai-research-assistant.jpg",
    techStack: [
    ...
    category: "AI/ML",
    year: "2025",
    github: "https://github.com/thenitinsharma/ai-research-assistant",
    demo: "https://ai-research-assistant-eight-beta.vercel.app",
    metrics: [
      { label: "Papers Indexed", value: "15,000+" },
      { label: "Vector Search", value: "FAISS" },
      { label: "Deployment", value: "Vercel + HF" },
    ],
    featured: true,
    highlights: [
  ...
  {
    id: "churn-prediction",
    name: "Telco Customer Churn Prediction & Segmentation",
    description:
      "End-to-end churn prediction and customer segmentation on IBM Telco dataset using Random Forest, XGBoost & K-Means",
    longDescription:
      "An end-to-end data science and machine learning project analyzing customer attrition patterns across 7,043 IBM Telco customers. After comprehensive exploratory data analysis and feature engineering, Random Forest and XGBoost classifiers were trained with class-imbalance compensation (scale_pos_weight, balanced class weights) and 5-fold cross validation, achieving a 0.857 ROC AUC and 77.3% churn recall. Built an unsupervised K-Means clustering layer on model churn probabilities to discover distinct behavioral customer segments for targeted retention campaigns.",
    ...
    category: "AI/ML",
    year: "2025",
    github: "https://github.com/thenitinsharma/Churn-Prediction",
    demo: "",
    metrics: [
      { label: "ROC AUC", value: "0.857" },
      { label: "Recall", value: "77.3%" },
      { label: "Segments", value: "3 Clusters" },
    ],
    featured: false,
    highlights: [
